                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
                        ...
                        <li className="nav-item _header_nav_item position-relative">
                            <span
                                id="_notify_btn"
                                className={`nav-link _header_nav_link _header_notify_btn ${isNotifyOpen ? "active" : ""}`}
                                onClick={() => {
                    ...
                    <div className="_header_nav_profile position-relative">
                        ...
                        <div className="_header_nav_dropdown">
                            <p className="_header_nav_para">{user?.email || "User"}</p>
                            <button
                                id="_profile_drop_show_btn"
                                className={`_header_nav_dropdown_btn _dropdown_toggle ${isProfileOpen ? "active" : ""}`}
                                type="button"
                                onClick={() => {
                            ...
                            <div id="_prfoile_drop" className="_nav_profile_dropdown _profile_dropdown" style={{ display: "block" }}>
                                <div className="_nav_profile_dropdown_info">
                                    ...
                                    <div className="_nav_profile_dropdown_info_txt">
                                        <h4 className="_nav_dropdown_title">{user?.email || "User"}</h4>
